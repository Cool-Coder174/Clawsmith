...
ClawSmith can register itself as an **OpenClaw skill**. See [openclaw_integration.md](openclaw_integration.md) for the full setup guide, including:
...
- [`.bat` Templates](bat_templates.md)
